...
contract TradingTest is BasicSetup {
    ...
    function testRequestMirrorSuccess() public {
        ...
        (address allocationAddress, bytes32 requestKey) = keeperRouter.requestMirror{value: 0.001 ether}(
            allocParams,
            callParams
        );
    ...
    function testRequestAdjustSuccess() public {
        ...
        vm.prank(keeper);
        vm.deal(keeper, 1 ether);
        bytes32 requestKey = keeperRouter.requestAdjust{value: 0.001 ether}(
            callParams,
            puppetList,
            keeperFee,
            keeper,
    ...
    function testSettleSuccess() public {
        ...
        address allocationAddress = allocation.getAllocationAddress(usdc, trader, puppetList, allocationId);
        ...
        vm.prank(keeper);
        (uint settledAmount, uint distributionAmount, uint platformFeeAmount) = keeperRouter.settle(
            settleParams,
            puppetList
        );
    ...
    function testCollectDust() public {
        ...
        address allocationAddress = allocation.getAllocationAddress(usdc, trader, puppetList, 1);
