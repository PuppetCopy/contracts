...
contract TradingForkTest is ForkTestBase {
    ...
    function testLiveGmxPositionMirror() public {
        ...
        bytes memory configBytes = keeperRouter.config();
    ...
    function testCompleteMirrorToSettlement() public {
        ...
        try keeperRouter.settleAllocation(
            settleParams,
            settleList
        ) {
            ...
            console.log("  Puppet1:", puppet1BalanceAfter > puppet1BalanceBefore ? "+" : "-", 
                       puppet1BalanceAfter > puppet1BalanceBefore ? 
                       puppet1BalanceAfter - puppet1BalanceBefore : 
                       puppet1BalanceBefore - puppet1BalanceAfter);
            console.log("  Puppet2:", puppet2BalanceAfter > puppet2BalanceBefore ? "+" : "-",
