...
export const CONTRACT_EVENT_MAP = {
  Allocate: {
    ...
    ExecuteAllocate: {
      ...
      args: [{type:"uint256",name:"subaccount"},{type:"address",name:"account"},{type:"uint256",name:"baseToken"},{type:"uint256",name:"intentAmount"},{type:"address[]",name:"puppetList"},{type:"uint256[]",name:"amountList"},{type:"uint256",name:"allocation"},{type:"uint256",name:"netValue"},{type:"uint256",name:"allocated"},{type:"uint256",name:"sharePrice"},{type:"uint256",name:"userShares"},{type:"uint256",name:"totalShares"},{type:"uint256",name:"nonce"}]
    },
    ExecuteWithdraw: {
  ...
  Match: {
    SetFilter: {
      ...
      args: [{type:"address",name:"puppet"},{type:"uint256",name:"dim"},{type:"bytes32",name:"value"},{type:"bool",name:"allowed"}]
    },
    SetPolicy: {
